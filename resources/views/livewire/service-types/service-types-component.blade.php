                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Billing Cycle</th>
                        ...
                        <tbody class="bg-white">
                            @forelse ($serviceTypes as $index => $serviceType)
                                <tr class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-200' }} hover:bg-blue-200 transition-colors duration-150">
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="text-xs text-gray-700">{{ Str::limit($serviceType->description, 50) ?: 'N/A' }}</div>
                                    </td>
                                    <td class="px-4 py-2 whitespace-nowrap">
                                        <div class="text-xs text-gray-900">{{ $serviceType->base_price ? 'UGX ' . number_format($serviceType->base_price, 2) : 'N/A' }}</div>
                                    </td>
                                    <td class="px-4 py-2 whitespace-nowrap">
                                        <div class="text-xs text-gray-900">{{ ucfirst($serviceType->billing_cycle) ?: 'N/A' }}</div>
                                    </td>
                                    <td class="px-4 py-2 whitespace-nowrap">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" wire:model="name"
                                        ...
                                        placeholder="e.g., Shared Service">
